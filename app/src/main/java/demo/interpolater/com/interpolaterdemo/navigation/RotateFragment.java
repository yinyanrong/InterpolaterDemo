...
public class RotateFragment extends BaseFragment {
    ...
    private void initAnim(){
        acceleraterDeceleraterAnim = AnimationUtils.loadAnimation(getContext(), R.anim.rotate_anim_accelerater_decelerate);
        acceleraterAnim = AnimationUtils.loadAnimation(getContext(), R.anim.rotate_anim_accelerater);
        decelerateAnim = AnimationUtils.loadAnimation(getContext(), R.anim.rotate_anim_decelerate);
        antipateAnim = AnimationUtils.loadAnimation(getContext(), R.anim.rotate_anim_anticipate);
        antipateovershotAnim = AnimationUtils.loadAnimation(getContext(), R.anim.rotate_anim_anticipate_overshot);
        bounceAnim = AnimationUtils.loadAnimation(getContext(), R.anim.rotate_anim_bounce);
        cycleAnim = AnimationUtils.loadAnimation(getContext(), R.anim.rotate_anim_cycle);
        linearAnim = AnimationUtils.loadAnimation(getContext(), R.anim.rotate_anim_linear);
        overshotAnim = AnimationUtils.loadAnimation(getContext(), R.anim.rotate_anim_overshot);
    }
    @Override
