...
public class AlphaFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View  view  =  inflater.inflate(R.layout.alpha_fragment,container,false);
    ...
    private void initAnim(){
        acceleraterDeceleraterAnim = AnimationUtils.loadAnimation(getContext(), R.anim.alpha_anim_accelerater_decelerate);
        acceleraterAnim = AnimationUtils.loadAnimation(getContext(), R.anim.alpha_anim_accelerater);
        decelerateAnim = AnimationUtils.loadAnimation(getContext(), R.anim.alpha_anim_decelerate);
        antipateAnim = AnimationUtils.loadAnimation(getContext(), R.anim.alpha_anim_anticipate);
        antipateovershotAnim = AnimationUtils.loadAnimation(getContext(), R.anim.alpha_anim_anticipate_overshot);
        bounceAnim = AnimationUtils.loadAnimation(getContext(), R.anim.alpha_anim_bounce);
        cycleAnim = AnimationUtils.loadAnimation(getContext(), R.anim.alpha_anim_cycle);
        linearAnim = AnimationUtils.loadAnimation(getContext(), R.anim.alpha_anim_linear);
        overshotAnim = AnimationUtils.loadAnimation(getContext(), R.anim.alpha_anim_overshot);
    }
